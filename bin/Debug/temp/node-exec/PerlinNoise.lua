...
--	by Stefan Gustavson
function fade(t) -- t:vec2
return mulV(t,mulV(t,mulV(t,mulV(t,addVC(subVC(mulVC(t,6),15),10)))))
end
function cnoise(P) -- P:vec2
...
out[x][y] = math.floor(pNoise(vec2(x, y), res)*255)
end
end
-- NODE EXEC --