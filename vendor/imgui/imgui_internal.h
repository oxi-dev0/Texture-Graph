...
//#endif
    ...
    IMGUI_API bool          ArrowButtonEx(const char* str_id, ImGuiDir dir, ImVec2 size_arg, ImGuiButtonFlags flags = 0, bool* hoveredPtr=nullptr, bool* selectedPtr=nullptr, bool headerCol = false);
